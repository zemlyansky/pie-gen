...
class PieChartGen:
    ...
    def calculateArcs(values):
        ...
        ds = []
        v = (Math.PI / 2)
        oldX = (150. + ((130 * ((Math.NaN if (((v == Math.POSITIVE_INFINITY) or ((v == Math.NEGATIVE_INFINITY)))) else python_lib_Math.cos(v))))))
        v1 = (Math.PI / 2)
        oldY = (150. - ((130 * ((Math.NaN if (((v1 == Math.POSITIVE_INFINITY) or ((v1 == Math.NEGATIVE_INFINITY)))) else python_lib_Math.sin(v1))))))
        totalAngle = 0
        _g = 0
        while (_g < len(values)):
            ...
            newX = (150. + ((130 * ((Math.NaN if (((v3 == Math.POSITIVE_INFINITY) or ((v3 == Math.NEGATIVE_INFINITY)))) else python_lib_Math.cos(v3))))))
            v4 = (totalAngle - ((Math.PI / 2)))
            newY = (150. + ((130 * ((Math.NaN if (((v4 == Math.POSITIVE_INFINITY) or ((v4 == Math.NEGATIVE_INFINITY)))) else python_lib_Math.sin(v4))))))
            x = (0 if ((angle < Math.PI)) else 1)
            ds.append((((((((((((((((((("M " + str(oldX)) + " ") + str(oldY)) + " A ") + str(130)) + " ") + str(130)) + " 0 ") + str(x)) + " 1 ") + str(newX)) + " ") + str(newY)) + " L ") + str(150.)) + " ") + str(150.)) + " Z"))
            oldX = newX
            oldY = newY
        return ds
    ...
    def calculateMiddlePoints(values,innerRadiusSize):
        ...
        while (_g < len(values)):
            ...
            newX = (150. + ((labelRadius * ((Math.NaN if (((v1 == Math.POSITIVE_INFINITY) or ((v1 == Math.NEGATIVE_INFINITY)))) else python_lib_Math.cos(v1))))))
            v2 = (totalAngle - ((Math.PI / 2)))
            newY = (150. + ((labelRadius * ((Math.NaN if (((v2 == Math.POSITIVE_INFINITY) or ((v2 == Math.NEGATIVE_INFINITY)))) else python_lib_Math.sin(v2))))))
    ...
    @staticmethod
    def hexToTriad(hex):
        _this = HxString.substring(hex,(hex.find("#") + 1),len(hex))
        cleanHex = list(_this)
    ...
    def create(values,params):
        ...
        ps = PieChartGen.calculateMiddlePoints(PieChartGen.normalizeValues(values),Reflect.field(params,"innerRadiusSize"))
        cs = PieChartGen.calculateColors(Reflect.field(params,"colors"),Reflect.field(values,"length"))
        _g1 = 0
